...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/manual', component: () => import('../views/ManualView.vue'), meta: { requiresAuth: true } },
    { path: '/admin/users', component: () => import('../views/UserManagementView.vue'), meta: { requiresAuth: true } },
    { path: '/admin/invite-codes', component: () => import('../views/InviteCodeManagementView.vue'), meta: { requiresAuth: true } },
    { path: '/admin/maps', component: () => import('../views/MapManagementView.vue'), meta: { requiresAuth: true } },
    { path: '/admin/client-versions', component: () => import('../views/ClientVersionManagementView.vue'), meta: { requiresAuth: true } },
